...
(function(w) {
    ...
    function hitDmp(visitorId) {
        ...
        sc.async = true;
        sc.src = dmpUrl + '/client/hit?condition=Y2xpZW50SWQ9MjM1NyZjb3VudGVySWQ9MTc2Mg==' + params + '&documentUrl=' + document.URL;
        var d = document.getElementsByTagName('script')[0];
        d.parentNode.insertBefore(sc, d);

        if('0' === '1') {
            typeof debugPageView === 'function' && debugPageView('Y2xpZW50SWQ9MjM1NyZjb3VudGVySWQ9MTc2Mg==');
        }
    }
